...
func (x *ListUserInfoRsp) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	var v UserInfo
	offset, err = fastpb.ReadMessage(buf, _type, &v)
	if err != nil {
		return offset, err
...
func (x *User) fastWriteField4(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 4, x.GetPhoneNum())
	return offset
}
...
func (x *UserInfo) fastWriteField2(buf []byte) (offset int) {
	...
	for i := range x.GetPosition() {
		offset += fastpb.WriteString(buf[offset:], 2, x.GetPosition()[i])
	}
	return offset
}
...
func (x *ListUserInfoRsp) fastWriteField3(buf []byte) (offset int) {
	if x.UserInfoList == nil {
		return offset
	}
	for i := range x.GetUserInfoList() {
		offset += fastpb.WriteMessage(buf[offset:], 3, x.GetUserInfoList()[i])
	}
	return offset
}
...
func (x *User) sizeField4() (n int) {
	...
	n += fastpb.SizeString(4, x.GetPhoneNum())
	return n
}
...
func (x *UserInfo) sizeField2() (n int) {
	...
	for i := range x.GetPosition() {
		n += fastpb.SizeString(2, x.GetPosition()[i])
	}
	return n
}
...
func (x *ListUserInfoRsp) sizeField3() (n int) {
	if x.UserInfoList == nil {
		return n
	}
	for i := range x.GetUserInfoList() {
		n += fastpb.SizeMessage(3, x.GetUserInfoList()[i])
	}
	return n
}
